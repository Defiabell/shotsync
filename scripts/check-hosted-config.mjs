...
if(c.vars.SUPABASE_SECRET_KEY || c.vars.PASSWORD_PEPPER)problems.push('Secrets must not be stored in Wrangler vars');
...
console.log('Hosted config ready. Confirm SUPABASE_SECRET_KEY and Turnstile secrets, disabled public provider signup, bucket lifecycle, and deployment authorization before publishing.');
