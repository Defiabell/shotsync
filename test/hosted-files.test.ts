...
const hosted = { ...bindings, SUPABASE_URL: 'https://abcdefghijklmnopqrst.supabase.co', SUPABASE_SECRET_KEY: 'sb_secret_test-provider-key', PUBLIC_ORIGIN: 'https://shotsync.test', UPLOADS_ENABLED: '1' };
